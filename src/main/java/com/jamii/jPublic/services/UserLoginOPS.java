        ...
        extends AbstractPublicServices
{
    ...
    public ResponseEntity<?> getResponse()
    {
        ...
        if (getIsSuccessful()) {
            ...
            userLoginRESP.setDateCreated(JamiiDateUtils.COOKIE_DATE.format(this.userCookies.data.getDatecreated().atZone(ZoneId.of("GMT"))));
            ...
            userLoginRESP.setExpiryDate(JamiiDateUtils.COOKIE_DATE.format(this.userCookies.data.getExpiredate().atZone(ZoneId.of("GMT"))));

...
import com.jamii.requests.social.BlockUserRequestREQ;
import com.jamii.responses.social.BlockUserRequestRESP;
...
@Service
public class BlockUserRequestOPS extends socialAbstract{
    ...
    public void processRequest() throws Exception {
        ...
        receiver = this.userLoginCONT.fetch( getBlockUserRequestREQ( ).getReceiveruserkey( ), UserLoginTBL.ACTIVE_ON );

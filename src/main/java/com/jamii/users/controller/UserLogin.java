...
import com.jamii.users.repo.UserLoginREPO;
import com.jamii.users.requests.CreateNewUserREQ;
 ...
 *     <li>Search users by username or email</li>
...
public class UserLogin
{
    ...
    /**
     * Searches for active users by username prefix.
     * 
     * @param searchString the prefix to search for in usernames
     * @return list of active users whose username starts with the search string
     */
    ...
    /**
     * Searches for active users by email address prefix.
     * 
     * @param searchString the prefix to search for in email addresses
     * @return list of active users whose email address starts with the search string
     */

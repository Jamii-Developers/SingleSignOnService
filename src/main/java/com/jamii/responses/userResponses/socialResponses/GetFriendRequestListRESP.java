...
public class GetFriendRequestListRESP extends AbstractResponses {
    ...
    List<GetFriendRequestListRESP.Results> results = new ArrayList<>( );

    public List<GetFriendRequestListRESP.Results> getResults() {
        return results;
    }

    public void setResults(List<GetFriendRequestListRESP.Results> results) {

...
import com.jamii.social.model.UserBlockListTBL;
import com.jamii.users.model.UserLoginTBL;
import com.jamii.social.repo.UserBlockListREPO;
 ...
 * 
 * <p>This class handles user blocking functionality, allowing users to block other users
 * from interacting with them. Blocked relationships can be tracked with different statuses.</p>
 * 
 * <p>Key functionality:</p>
 * <ul>
 *     <li>Fetch block list records by users and status</li>
...
public class UserBlockList
{
    ...
    /**
     * Fetches all blocked users for a specific user with status filter.
     * 
     * @param user the user to fetch the block list for
     * @param status the status to filter by
     * @return list of blocked users matching the criteria
     */

...
import com.jamii.social.model.UserRequestsTBL;
import com.jamii.social.repo.UserRequestsREPO;
 ...
 * 
 * <p>This class handles pending relationship requests between users, such as friend requests
 ...
 *     <li>Fetch requests by users, type, and status</li>
...
public class UserRequest
{
    ...
    /**
     * Fetches request records between two users.
     * 
     * @param user_1 the user who sent the request
     * @param user_2 the user who received the request
     * @return list of request records between the two users
     */
    ...
    /**
     * Fetches request records between two users with status filter.
     * 
     * @param user_1 the user who sent the request
     * @param user_2 the user who received the request
    ...
    /**
     * Fetches request records between two users with type and status filters.
     * 
     * @param user_1 the user who sent the request
     * @param user_2 the user who received the request
    ...
    /**
     * Adds a new relationship request between two users.
     * 

...
/**
 * Service for retrieving the list of pending friend requests for an authenticated user.
 * 
 * <p>This service allows authenticated users to retrieve all pending friend requests
 * they have received, showing the users who want to be friends with them along with their
 ...
 *   <li>Fetch pending friend requests from database</li>
 ...
 *   <li>No pending friend requests found</li>
 * </ul>
 * 
 * @see AbstractUserServicesOPS
 * @see GetFriendRequestListServicesREQ
 */
@Service
public class GetFriendRequestListOPS
        extends AbstractUserServicesOPS
{
    ...
    /** Request object containing friend request list data */
    protected GetFriendRequestListServicesREQ req = null;

    /**
     * Maps the incoming request to a {@link GetFriendRequestListServicesREQ} and extracts the
     * authentication keys required for session validation.
     */
    @Override
    protected void setUserRequestData()
    {
        req = new GetFriendRequestListServicesREQ();
        req = (GetFriendRequestListServicesREQ) JamiiMapperUtils.mapObject(getRequest(), GetFriendRequestListServicesREQ.class);
